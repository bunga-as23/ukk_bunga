    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link text-center">
                <span class="brand-text font-weight-light font-weight-bold">Bunga Laundry</span>
            </a>
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <!-- <a href="#" class="d-block"><?= $this->session->userdata('nama_user') . '-' . $this->session->userdata('role') ?></a> -->
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            <a onclick="return confirm('Yakin ingin keluar?')" href="<?= base_url('auth/logout') ?>" class="nav-link">
