...
class Transaksi extends CI_Controller
{
    ...
    //     $data['title'] = 'Cetak Transaksi';
    //     // $data['transaksi'] = $this->Transaksi_m->cetak($id_transaksi);
    //     // $data['transaksi'] = $this->Transaksi_m->getTransaksiById($id_transaksi);
    //     $data['transaksi'] = $this->Transaksi_m->getDetailTransaksiById($id_transaksi);
    //     $this->load->view('transaksi/cetak', $data);
    // }
}
